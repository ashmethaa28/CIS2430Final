public class Heroic extends Difficulty implements Challenge {
 ...
 */
  public Heroic(double constant, String id, int numChallenges, double score, int coins, double time, int lives) {
